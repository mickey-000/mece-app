...
def generate_quiz(category_type):
    ...
    try:
        ...
        return {"title": "通信エラー", "q": "再読み込みしてください", "opts": ["A", "B", "C"], "cor": "A", "exp": "エラー"}
...
# --- 5. メイン画面 ---
st.set_page_config(page_title="Biz Logic Gym 3+2", page_icon="⚡")

if not st.session_state.game_active:
    st.title("⚡ Biz Logic Gym: Hybrid")
    st.write("MECE 3問 ＋ フェルミ推定 2問 の集中トレーニング。")
